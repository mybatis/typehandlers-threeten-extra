...
/**
 * Type Handler for ThreeTen-Extra's {@link DayOfMonth}.
 *
...
public class DayOfMonthTypeHandler extends BaseTypeHandler<DayOfMonth> {
  ...
  @Override
  public void setNonNullParameter(PreparedStatement ps, int parameterIndex, DayOfMonth dayOfMonth, JdbcType type)
      throws SQLException {
